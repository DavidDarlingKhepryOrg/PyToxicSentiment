...
# Article reference this code (adjusted for Python 3):
...
for word in movie_reviews.words(categories=['pos']):
    word_fd = FreqDist(word.lower())
    label_word_fd['pos'] = FreqDist(word.lower())

for word in movie_reviews.words(categories=['neg']):
    word_fd = FreqDist(word.lower())
    label_word_fd['neg'] = FreqDist(word.lower())
